...
<ul>
  ...
  <li class="dropdown">
   ...
   <li><a href="#news">About Us</a></li>
	...
	Account Type <input type = "text" name = "accounttype" value = "<%=accounttype%>" readonly><br>
	No Of Cheque Books <input type = "text" name = "noofchequebooks" value = "<%=noofchequebooks%>" readonly><br>
